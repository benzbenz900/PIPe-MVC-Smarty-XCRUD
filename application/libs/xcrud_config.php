...
class Xcrud_config
{
    ...
    public static $upload_folder_def = '../../upload'; // Default uploads folder on your site, relative to xCRUD folder or absolute path required. Folder is must exist.
    ...
    public static $date_format = 'Y-m-d'; // jqueryui date format
    public static $time_format = 'H:i:s'; // jqueryui time format
